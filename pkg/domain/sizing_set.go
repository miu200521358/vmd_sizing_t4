...
func (ss *SizingSet) insertDebugBones(bones *pmx.Bones, displaySlots *pmx.DisplaySlots) error {
	...
	for _, v := range [][]any{
		...
		// 出力
		{"元今左足首1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左足首D1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左足EX1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先D1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先P1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先PD1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先C1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今左爪先CD1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"先今右足K0", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右足首1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右足首D1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右足EX1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先D1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先P1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先PD1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先C1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右爪先CD1", rootBone.Index(), mmath.NewMVec3(), "足11P"},
		{"元今右足K0", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左足首1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左足首D1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左足EX1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先D1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先P1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先PD1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先C1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今左爪先CD1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右足K0", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右足首1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右足首D1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右足EX1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先D1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先P1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先PD1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先C1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右爪先CD1", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		{"先今右足K0", rootBone.Index(), mmath.NewMVec3(), "足11R"},
		// 上半身補正
