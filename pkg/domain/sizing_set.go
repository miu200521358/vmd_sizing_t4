...
func (ss *SizingSet) insertDebugBones(bones *pmx.Bones, displaySlots *pmx.DisplaySlots) error {
	...
	for _, v := range [][]any{
		...
		{"先理左足4", rootBone.Index(), mmath.NewMVec3(), "足04先"},
		{"先結左足4", rootBone.Index(), mmath.NewMVec3(), "足04先"},
		...
		{"先理右足4", rootBone.Index(), mmath.NewMVec3(), "足04先"},
		{"先結右足4", rootBone.Index(), mmath.NewMVec3(), "足04先"},
		...
		{"元今左足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先今左足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先結左足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"元今右足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先今右足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先結右足EX8", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"元左足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"元距左足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先FK左足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先IK左足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先理左足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"元右足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"元距右足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先FK右足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先IK右足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		{"先理右足V", rootBone.Index(), mmath.NewMVec3(), "足08"},
		// センター補正(2回目)
		...
		// 足固定
		{"元今左足首3", rootBone.Index(), mmath.NewMVec3(), "足13"},
		{"先今左足首3", rootBone.Index(), mmath.NewMVec3(), "足13"},
		{"元今右足首3", rootBone.Index(), mmath.NewMVec3(), "足13"},
		{"先今右足首3", rootBone.Index(), mmath.NewMVec3(), "足13"},
		// 上半身補正
